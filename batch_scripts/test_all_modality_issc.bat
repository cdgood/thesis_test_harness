...
set test_name=test_all_modality_issc
...
set flags=--cuda 0 --dataset grss_dfc_2018 --skip-data-postprocessing --model-id 3d-densenet-modified --center-pixel --split-mode fixed --optimizer nadam %training_params% %hs_flags% %lidar_ms_flags% %lidar_ndsm_flags% %vhr_rgb_flags%
