...
set titles[1]=test_hs_and_lidar-ms_and_vhr-rgb%title_params%
set experiment_flags[1]=%flags% %hs_flags% %lidar_ms_flags% %vhr_rgb_flags%

set titles[2]=test_all_modalities%title_params%
set experiment_flags[2]=%flags% %hs_flags% %lidar_ms_flags% %lidar_ndsm_flags% %vhr_rgb_flags%

set num_experiments=2
