@echo off
@break off
@title Run hyperspectral PCA band reduction tests with data augmentation
@color 0a
@cls
...
set test_name=test_hs_pca_augmented
...
echo "test_hs_pca_augmented.bat script completed!"