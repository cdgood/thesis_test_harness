...
:: Run Experiments
set experiment=%test_name%%title_params%_pca_var95
python main.py --experiment-name !experiment! --experiment-number %max_num_channels% --output-path %working_dir% --save-experiment-path "%save_experiment_path%!experiment!.json" --band-reduction-method pca --n-components 0.95 %flags% 
