...
set test_name=test_hs_issc_augmented
...
set vhr_rgb_flags=--use-vhr-data --hs-resampling cubic_spline
...
set experiment=%test_name%%title_params%_17_bands
python main.py --experiment-name !experiment! --experiment-number 17 --output-path %working_dir% --save-experiment-path "%save_experiment_path%!experiment!.json" --band-reduction-method issc --n-components 17 %flags% 
